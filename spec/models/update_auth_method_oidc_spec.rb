...
# Unit tests for Akeyless::UpdateAuthMethodOIDC
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Akeyless::UpdateAuthMethodOIDC do
  let(:instance) { Akeyless::UpdateAuthMethodOIDC.new }

  describe 'test an instance of UpdateAuthMethodOIDC' do
    it 'should create an instance of UpdateAuthMethodOIDC' do
      expect(instance).to be_instance_of(Akeyless::UpdateAuthMethodOIDC)
    end
  end
